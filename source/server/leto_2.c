/*  $Id: leto_2.c,v 1.4 2010/07/09 10:42:27 aokhotnikov Exp $  */
...
extern void leto_runFunc( PUSERSTRU pUStru, PHB_DYNS* ppSym, const char* szName, const char* pCommand, ULONG ulLen );
...
HB_FUNC( LETO_SERVER )
{
   ...
   hThread2 = hb_threadCreate( &th_id2, thread2, (void*) szThread2Data );
